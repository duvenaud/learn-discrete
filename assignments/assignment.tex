...
\assignment{\hspace{-3cm} DRAFT: Discrete Variables and Gradient Estimators}
\duedate{TBD}
...
\begin{problem}[Comparing variances of gradient estimators, 10 points]
...
\begin{problem}[Representing and computing Categorical distributions, 10 points]
